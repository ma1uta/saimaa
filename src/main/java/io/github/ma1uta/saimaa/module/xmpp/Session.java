...
import io.github.ma1uta.saimaa.module.xmpp.dialback.Result;
import io.github.ma1uta.saimaa.module.xmpp.dialback.Verify;
...
public abstract class Session implements AutoCloseable {
    ...
    private final XmppModule xmppModule;
    private String domain;

    public Session(XmppModule xmppModule) throws JAXBException {
    ...
    private boolean isTargetDomainWrong(String domain) {
        if (!getXmppModule().getConfig().getDomain().equals(domain)) {
