...
package io.github.ma1uta.saimaa.module.xmpp.netty;

import io.github.ma1uta.saimaa.Loggers;
import io.github.ma1uta.saimaa.module.xmpp.IncomingSession;
import io.github.ma1uta.saimaa.module.xmpp.XmppModule;
import io.github.ma1uta.saimaa.module.xmpp.babbler.netty.NettyChannelConnection;
import io.github.ma1uta.saimaa.module.xmpp.dialback.DialbackNegotiator;
import io.github.ma1uta.saimaa.module.xmpp.sasl.SaslNegotiator;
...
public class XmppServerInitializer extends XmppNettyInitializer<SocketChannel, IncomingSession> {
    ...
    public XmppServerInitializer(XmppModule xmppModule) {
        super(xmppModule);
    }
