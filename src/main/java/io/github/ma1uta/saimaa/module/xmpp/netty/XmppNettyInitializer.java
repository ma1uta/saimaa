...
import io.github.ma1uta.saimaa.module.xmpp.Session;
...
public abstract class XmppNettyInitializer<C extends Channel, S extends Session> extends ChannelInitializer<C> {
    ...
    private final XmppModule server;

    protected XmppNettyInitializer(XmppModule server) {
        this.server = server;
    }

    public XmppModule getServer() {
        return server;
    }
}
